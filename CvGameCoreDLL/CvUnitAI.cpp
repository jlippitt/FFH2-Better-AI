...
/*************************************************************************************************/
/**	BETTER AI (first city) Sephi 0.41k                                     		                **/
/**																								**/
/**						                                            							**/
/*************************************************************************************************/
...
/*************************************************************************************************/
/** BETTER_BTS_AI_MOD 0.41k                12/07/08                                jdog5000      */
/**                                                                                              */
...
/*************************************************************************************************/
/** BETTER_BTS_AI_MOD 0.41k                06/02/09                                jdog5000      */
/**                                                                                              */
...
/*************************************************************************************************/
/** BETTER_BTS_AI_MOD merged Sephi 0.41k               01/14/09                    jdog5000      */
/**                                                                                              */
/** Settler AI                                                                                   */
/*************************************************************************************************/
...
/*************************************************************************************************/
/**	BETTER AI (Religion Victory) Sephi 0.41k                                         		                **/
/**																								**/
/**						                                            							**/
/*************************************************************************************************/
...
/**	not sure if all this is needed anymore?														**/
/**						                                            							**/
/*************************************************************************************************/
...
void CvUnitAI::AI_barbsmashermove()
{
    ...
    if (GET_PLAYER(getOwnerINLINE()).isConquestMode())
    {
        CLLNode<IDInfo>* pUnitNode;
        CvUnit* pLoopUnit;
        pUnitNode = getGroup()->plot()->headUnitNode();
        while (pUnitNode != NULL)
        {
            pLoopUnit = ::getUnit(pUnitNode->m_data);
            pUnitNode = plot()->nextUnitNode(pUnitNode);
...
{
    int iFeast = GC.getDefineINT("SPELL_FEAST");
    if (iFeast != NO_SPELL)
    {
        ...
        else if (getExperience()>30 || !(plot()->isCity()))
        {
        ...
        if (pCity)
        {
            if (pCity->getPopulation()>13)
            {
                if (canCast(iFeast,false))
                {
                    cast(iFeast);
                }
                getGroup()->pushMission(MISSION_SKIP);
...
void CvUnitAI::PatrolNewMove()
{
    ...
    else if (!newGroup && pBestGroup!=NULL)
    {
        ...
        {
            getGroup()->pushMission(MISSION_MOVE_TO_UNIT, pBestGroup->getHeadUnit()->getOwnerINLINE(),pBestGroup->getHeadUnit()->getID(),0,false,false, MISSIONAI_GROUP, NULL, pBestGroup->getHeadUnit());
        }
        return;
    }
...
void CvUnitAI::ConquestMove()
{
    ...
    if (plot()->getOwnerINLINE()==getOwnerINLINE())
    {
        ...
        else
        {
            ...
            if (!(getGroup()->getNumUnits()>15 || getGroup()->getNumUnits()>GET_PLAYER(getOwnerINLINE()).getNumCities()*3))
            {
...
bool CvUnitAI::AI_Lokimove()
{
    ...
    if (plot()->isCity())
    {
        if (GC.getDefineINT("SPELL_DISRUPT") != NO_SPELL)
        {
...
void CvUnitAI::AI_mageCast()
{
    ...
    {
        iValue = GC.getSpellInfo((SpellTypes)iSpell).getAIWeightWar();
        if (bCity)
        {
            iValue += GC.getSpellInfo((SpellTypes)iSpell).getAIWeightCity();
        }
        if (iValue > 0)
        {
...
bool CvUnitAI::isMovementCaster()
{
    ...
    int iHaste = GC.getDefineINT("SPELL_HASTE");
    if (iHaste == NO_SPELL)
    {
        return false;
    }
    if (canCast(iHaste,false))
    {
        return true;
    }
    return false;
...
void CvUnitAI::AI_SettleNavalPickupMove()
{
    ...
    while (pEntityNode != NULL)
    {
        ...
        iTotalCargo += pLoopUnit->cargoSpace();
