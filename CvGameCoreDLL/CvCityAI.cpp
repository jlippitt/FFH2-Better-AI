...
/*************************************************************************************************/
    ...
    if (!isHuman())
    {
        //Choose which City produces Better Defense Units for this City
        AI_CityChooseDefenseProduction();
        //Choose which City produces Better Patrol Units for this City
        AI_CityChoosePatrolProduction();
    }
/*************************************************************************************************/
/**	END	                                        												**/
/*************************************************************************************************/
...
//FfH: Modified by Kael 01/26/2010
//							if (iHurryGold < (GET_PLAYER(getOwnerINLINE()).getGold() / 3))
							if (iHurryGold < ((GET_PLAYER(getOwnerINLINE()).getGold() - GET_PLAYER(getOwnerINLINE()).AI_getGoldReserve()) / 3))
//FfH: End Modify
...
//				if ((iHurryGold > 0) && ((iHurryGold * 16) < GET_PLAYER(getOwnerINLINE()).getGold()))
				if ((iHurryGold > 0) && ((iHurryGold * 16) < (GET_PLAYER(getOwnerINLINE()).getGold() - GET_PLAYER(getOwnerINLINE()).AI_getGoldReserve())))
//FfH: End Modify
...
**/
						int iHurryGold = hurryGold((HurryTypes)iI);
						if (GET_PLAYER(getOwnerINLINE()).getGold() - GET_PLAYER(getOwnerINLINE()).AI_getGoldReserve() > iHurryGold)
						{
							hurry((HurryTypes)iI);
							break;
						}
						...
						if (pLoopUnit->isEnemy(getTeam()))
						{
							if (pLoopUnit->canAttack())
							{
								if (!(pLoopUnit->isInvisible(getTeam(), false)))
								{
								    ...
								    {
//								        tempvalue=GC.getUnitInfo(pLoopUnit->getUnitType()).getPowerValue();
//								        tempvalue*=((100+35*pLoopUnit->getMoves())/100);
                                        tempvalue=std::max(5,tempvalue);
								        tempvalue/=(iDistance+1);
