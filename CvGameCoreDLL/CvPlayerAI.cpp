...
/*************************************************************************************************/
                        if (pLoopPlot->isFreshWater())
                        {
                            ...
                            if (eFeature != NO_FEATURE)
                            {
                                if (GC.getFeatureInfo(eFeature).getYieldChange(YIELD_FOOD) > 2) //Flood Plains and Oasis
                                {
                                    iSpecialFood ++;
                                }
                            }
...
int CvPlayerAI::AI_getGoldReserve()  const
{
    if (isHuman())
    {
        return 0;
...
//FfH: Added by Kael 01/26/2010
		if (!isHuman())
		{
			iMaxGold-=AI_getGoldReserve();
		}
//FfH: End Add
